...
/**
 * Test-only plugin for installing the Hudi connector into a query runner. The production
 * {@code HudiPlugin} lives in Trino's {@code plugin/trino-hudi} module (RFC-105).
 */
        ...
        implements Plugin
{
    ...
    /**
     * Installs the production {@link HudiConnectorFactory}.
     */
    ...
    /**
     * Installs a {@link TestingHudiConnectorFactory} backed by a local file system rooted at the given path.
     */
